...
const App = Vue.createApp({
	data() {
      ...
      newType:"",
      newPic:"",
     //new code added on aug 11 and un-commented on aug 13
      selectedAnimals:"",
     
    };
	},
	computed: {
    //new code added on aug 11th for the filter function, updated on aug 13
    filteredAnimals(){
      if(this.selectedAnimals== ""){
        return this.animals
      }else{
        //learned this line of code (how to use "filter") from cogmos filtering user's learning target function
        //this does not seem to work
        return this.animals.filter (
        (animal)=> animal.name == this.selectedAnimals
        )
      }
    },
    //new code ends here
